...
sendPasswordResetEmail(auth, email)
  ...
  return (
      <div className='bg-gray-600 h-screen pt-10'>
        ...
        <div className="">
          <p className='font-semibold text-primary text-opacity-[0.7] text-[20px] text-white font-nunito cursor-pointer border-[1px] border-primary px-[30px] py-[16px] rounded hover:bg-black hover:text-primary  duration-300'><Link href='/sign-in'>Back to log in</Link></p>
        </div>
        </div>
       </div>
