      ...
      <div className='flex'>
        <div className=' mt-[140px]'>
          ...
          <div className='flex justify-center gap-5'>
            ...
            <div className="flex items-center justify-center py-[22px] border-[1px] border-[#03014C]-[0.3] w-[220px] rounded-[8.34px] cursor-pointer mt-[30px]" onClick={microsoftClick}>
              <FcGoogle className='w-[20px] h-[20px]' />
          ...
          {verifyMessage && (
            <p className="leading-[20px] mt-[20px] text-center bg-[#ffdce0] py-[10px] border-red-200 border-[1px] text-[18px] font-nunito font-semibold text-red-400">{verifyMessage}</p>
          )}
          ...
          <div className="mt-[62px] relative">
            <input
              ...
              className='w-[500px] py-[20px] pr-[65px] border-b-[2px] outline-0 text-[#11175D] border-[#11175D] border-opacity-[0.3] placeholder:text-[#03014C] placeholder:font-semibold placeholder:text-opacity-[0.4] placeholder:text-[20px]'
            />
          ...
          <div className="mt-[54px] relative ">
            <input
              ...
              className='w-[500px] py-[20px] pr-[65px] border-b-[2px] outline-0 text-[#11175D] border-[#11175D] border-opacity-[0.3] placeholder:text-[#03014C] placeholder:font-semibold placeholder:text-[20px] placeholder:text-opacity-[0.4]'
            />
          ...
          <div className="select-none mt-[52px] w-[368px] pb-[50px]">
            ...
            <p className='text-left mt-[35px] text-[#03014C] font-sans text-[13px] font-normal'>Don’t have an account? <span className='text-[#EA6C00] text-[13px] font-sans font-bold cursor-pointer'><Link href='/sign-up'>Sign up</Link></span></p>
          </div>
        </div>
      </div>
    </div>
